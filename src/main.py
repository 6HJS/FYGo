...
class GoBoard:
    def __init__(self, size=19):
        ...
        self.prev_board = None  # 上一步的棋盘状态
        self.prev_prev_board = None  # 上上步的棋盘状态
    ...
    def is_valid_move(self, row, col, player):
        ...
        simulated_board = [r.copy() for r in self.board]
        self.board = original_board

        if self.prev_board is not None and simulated_board == self.prev_board:
            return False
